...
class Product {
public:
    void displayProductInfo(int productCode);
};
void Product::displayProductInfo(int productCode)
...
int main() {
    ...
    Product obj;
    // Call the function to display product info
    obj.displayProductInfo(code);
